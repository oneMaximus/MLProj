...
ax2.plot(data.index[train_size:], y_pred_test_best, label='Predicted S&P 500 Closing Price (Test, Time + RSI + Stochastic_Oscillator + ROC + MOM + Williams_%R)', color='red', linestyle='--')
ax2.set_xlabel('Date')
ax2.set_ylabel('S&P 500 Closing Price')
ax2.set_title('SVR: Actual vs Predicted S&P 500 Closing Prices (Test Period, Time + RSI + Stochastic_Oscillator + ROC + MOM + Williams_%R, Tuned)')
ax2.legend()
ax2.grid(True)
